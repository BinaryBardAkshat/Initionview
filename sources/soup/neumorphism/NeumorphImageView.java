...
public final class NeumorphImageView extends AppCompatImageView {
    ...
    public /* synthetic */ NeumorphImageView(Context context, AttributeSet attributeSet, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i3 & 2) != 0 ? null : attributeSet, (i3 & 4) != 0 ? R.attr.neumorphImageViewStyle : i, (i3 & 8) != 0 ? R.style.Widget_Neumorph_ImageView : i2);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NeumorphImageView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet2, R.styleable.NeumorphImageView, i3, i4);
        ...
        int i5 = obtainStyledAttributes.getInt(R.styleable.NeumorphImageView_neumorph_lightSource, 0);
        int i6 = obtainStyledAttributes.getInt(R.styleable.NeumorphImageView_neumorph_shapeType, 0);
        ...
        int color = NeumorphResources.INSTANCE.getColor(context2, obtainStyledAttributes, R.styleable.NeumorphImageView_neumorph_shadowColorLight, R.color.design_default_color_shadow_light);
        int i10 = dimensionPixelSize2;
        int color2 = NeumorphResources.INSTANCE.getColor(context2, obtainStyledAttributes, R.styleable.NeumorphImageView_neumorph_shadowColorDark, R.color.design_default_color_shadow_dark);
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lsoup/neumorphism/NeumorphImageView$Companion;", "", "()V", "LOG_TAG", "", "neumorphism_release"}, k = 1, mv = {1, 1, 16})
    /* compiled from: NeumorphImageView.kt */
