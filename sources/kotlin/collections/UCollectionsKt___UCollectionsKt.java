...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m117constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m128setVurrAj0(r0, i, r2.m115unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m195constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m206setVXSXFK8(r0, i, r2.m193unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m273constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m284setk8EXiF4(r0, i, r2.m271unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m377constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m388set01HTLdE(r0, i, r2.m375unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m142constructorimpl(i + r1.m193unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m220constructorimpl(j + r2.m271unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m142constructorimpl(i + UInt.m142constructorimpl(r1.m115unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m142constructorimpl(i + UInt.m142constructorimpl(r1.m375unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
