...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1433copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1435copyRFiDyg4(t, j);
    }
    ...
    public final TimedValue<T> m1435copyRFiDyg4(T t, long j) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1392toStringimpl(this.duration) + ")";
    }
