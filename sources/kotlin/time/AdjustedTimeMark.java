...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1334getAdjustmentUwyO8pc() {
    ...
    public long m1333elapsedNowUwyO8pc() {
        return Duration.m1378minusLRDsOJo(this.mark.m1430elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1335plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1379plusLRDsOJo(this.adjustment, j));
    }
}
