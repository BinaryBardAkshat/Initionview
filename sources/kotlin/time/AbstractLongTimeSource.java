...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public long m1331elapsedNowUwyO8pc() {
        ...
        public TimeMark m1332plusLRDsOJo(long j) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1379plusLRDsOJo(this.offset, j));
        }
    }

    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1403getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
