...
public final class URandomKt {
    public static final int nextUInt(Random random) {
        ...
        return UInt.m142constructorimpl(random.nextInt());
    }
    ...
    public static final int m1253nextUInta8DCA5k(Random random, int i, int i2) {
        ...
        return UInt.m142constructorimpl(random.nextInt(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) ^ Integer.MIN_VALUE);
    }
    ...
    public static final int nextUInt(Random random, UIntRange uIntRange) {
        ...
        } else if (UnsignedKt.uintCompare(uIntRange.m1258getLastpVg5ArA(), -1) < 0) {
            return m1253nextUInta8DCA5k(random, uIntRange.m1257getFirstpVg5ArA(), UInt.m142constructorimpl(uIntRange.m1258getLastpVg5ArA() + 1));
        } else {
            if (UnsignedKt.uintCompare(uIntRange.m1257getFirstpVg5ArA(), 0) > 0) {
                return UInt.m142constructorimpl(m1253nextUInta8DCA5k(random, UInt.m142constructorimpl(uIntRange.m1257getFirstpVg5ArA() - 1), uIntRange.m1258getLastpVg5ArA()) + 1);
            }
    ...
    public static final long m1255nextULongV1Xi4fY(Random random, long j) {
        Intrinsics.checkNotNullParameter(random, "$this$nextULong");
        return m1256nextULongjmpaWc(random, 0, j);
    }
    ...
    public static final long m1256nextULongjmpaWc(Random random, long j, long j2) {
        ...
        return ULong.m220constructorimpl(random.nextLong(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) ^ Long.MIN_VALUE);
    }
    ...
    public static final long nextULong(Random random, ULongRange uLongRange) {
        ...
        } else if (UnsignedKt.ulongCompare(uLongRange.m1265getLastsVKNKU(), -1) < 0) {
            return m1256nextULongjmpaWc(random, uLongRange.m1264getFirstsVKNKU(), ULong.m220constructorimpl(uLongRange.m1265getLastsVKNKU() + ULong.m220constructorimpl(((long) 1) & 4294967295L)));
        } else {
            if (UnsignedKt.ulongCompare(uLongRange.m1264getFirstsVKNKU(), 0) <= 0) {
                return nextULong(random);
            }
            long j = ((long) 1) & 4294967295L;
            return ULong.m220constructorimpl(m1256nextULongjmpaWc(random, ULong.m220constructorimpl(uLongRange.m1264getFirstsVKNKU() - ULong.m220constructorimpl(j)), uLongRange.m1265getLastsVKNKU()) + ULong.m220constructorimpl(j));
        }
    }
    ...
    public static final byte[] nextUBytes(Random random, int i) {
        Intrinsics.checkNotNullParameter(random, "$this$nextUBytes");
        return UByteArray.m118constructorimpl(random.nextBytes(i));
    }
    ...
    public static final void m1248checkUIntRangeBoundsJ1ME1BU(int i, int i2) {
        if (!(UnsignedKt.uintCompare(i2, i) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m136boximpl(i), UInt.m136boximpl(i2)).toString());
        }
    }
