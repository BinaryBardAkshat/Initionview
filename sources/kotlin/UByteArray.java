...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static byte[] m118constructorimpl(byte[] bArr) {
    ...
    public static boolean m121equalsimpl(byte[] bArr, Object obj) {
        return (obj instanceof UByteArray) && Intrinsics.areEqual((Object) bArr, (Object) ((UByteArray) obj).m132unboximpl());
    }
    ...
    public boolean m131contains7apg3OU(byte b) {
        return m119contains7apg3OU(this.storage, b);
    }

    public boolean containsAll(Collection<? extends Object> collection) {
        return m120containsAllimpl(this.storage, collection);
    }

    public boolean equals(Object obj) {
        return m121equalsimpl(this.storage, obj);
    }

    public int getSize() {
        return m124getSizeimpl(this.storage);
    }

    public int hashCode() {
        return m125hashCodeimpl(this.storage);
    }

    public boolean isEmpty() {
        return m126isEmptyimpl(this.storage);
    }

    public java.util.Iterator<UByte> iterator() {
        return m127iteratorimpl(this.storage);
    }
    ...
    public String toString() {
        return m129toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UByte) {
            return m131contains7apg3OU(((UByte) obj).m115unboximpl());
        }
        return false;
    }
    ...
    public static final byte m123getw2LRezQ(byte[] bArr, int i) {
        return UByte.m66constructorimpl(bArr[i]);
    }
    ...
    public static java.util.Iterator<UByte> m127iteratorimpl(byte[] bArr) {
    ...
    private static final class Iterator extends UByteIterator {
        ...
        public byte m133nextUBytew2LRezQ() {
            int i = this.index;
    ...
    public static boolean m120containsAllimpl(byte[] bArr, Collection<UByte> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, "elements");
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof UByte) || !ArraysKt.contains(bArr, ((UByte) next).m115unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
