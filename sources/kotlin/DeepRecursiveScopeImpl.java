    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r;
            } else if (Result.m50equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    ...
                    if (function3 != null) {
                        ...
                        if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m48constructorimpl(invoke));
                        }
                    } else {
                    ...
                    continuation.resumeWith(Result.m48constructorimpl(ResultKt.createFailure(th)));
                }
            } else {
